...
public class UPnPDiscovery extends AsyncTask {
    ...
    private UPnPDiscovery(Context context, OnDiscoveryListener listener) {
        mContext = context;
        mListener = listener;
        mTheardsCount = 0;
    ...
    public static boolean discoveryDevices(Context context, OnDiscoveryListener listener) {
        UPnPDiscovery discover = new UPnPDiscovery(context, listener);
        discover.execute();
        try {
